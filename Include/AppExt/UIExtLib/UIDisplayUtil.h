...
#define SHOW_BEGIN(Name) SHOW_ELEMENT Name##Show[]={
#define SHOW_ITEM(cmd,x1,y1,x2,y2,parm1,parm2,style,p1,p2,p3,p4,p5,p6)     \
                {{cmd,x1,y1,x2,y2,parm1,parm2},{style,p1,p2,p3,p4,p5,p6}},
#define SHOW_END {{CMD_DrawNull,0},{0}},};
