...
#define DMARD07_WRITE_ID 0x38
#define DMARD07_READ_ID 0x39
...
extern int mir3da_i2c_init(void);
extern BOOL mir3da_chip_init(void);
extern int mir3da_read_data(short *x, short *y, short *z);
extern int mir3da_open_interrupt(int num);
extern int mir3da_close_interrupt(int num);
extern int mir3da_read_interrupt_statu();
...
extern void GSensorSensitivityReset(UINT32 level);
