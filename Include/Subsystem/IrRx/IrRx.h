...
#define IRRX_DATA_BUF_NUM               3           // Circular queue, so max buffer available is (IRRX_DATA_BUF_NUM-1) !
...
typedef struct _IRRX_DEVICE_OBJ
{
    ...
    UINT32      uiGPIOIntr;             // GPIO interrupt number for IR remote control receiver
