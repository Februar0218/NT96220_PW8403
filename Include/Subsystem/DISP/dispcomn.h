...
typedef enum
{
    DISP_1,     ///< Display ID 1. In the NT96220, this is used to specify IDE.
    DISP_2,     ///< Display ID 2. In the NT96220, this is used to specify memory interface engine's DRAM direct path.
...
typedef enum
{
    ...
    DISPLAYER_MASK = 0x0A,                  ///< Valid display layer selection mask

    DISPLAYER_VDO2 = 0x10,                  // NT96220 has no VDO2
    DISPLAYER_OSD2 = 0x04,                  // NT96220 has no OSD2
...
typedef enum
{
    ...
    DISPABI_GAMMA           = 0x00000004,   ///< The display engine supports Gamma adjustment.
