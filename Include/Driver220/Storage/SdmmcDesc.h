/**
    Header file for SD/MMC Card Structure definition.

    @file       SdmmcDesc.h
    @ingroup    mIStgSDIO

    @brief      SD/MMC Card Structure header
...
/**
    SD memory card CID register fields.

    Structure definition for SD memory card CID register fields.

    @note   For more detail descriptions, please refer to SD 3.0 spec.
*/
typedef struct
{
...
/**
    MMC memory card CID register fields.

    Structure definition for MMC memory card CID register fields.

    @note   For more detail descriptions, please refer to MMC spec.
*/
typedef struct
{
