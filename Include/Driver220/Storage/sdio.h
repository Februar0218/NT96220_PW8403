...
/**
    ...
    @note for sdio_setDetectCardExistHdl(), sdio_setDetectCardProtectHdl()
*/
//@{
...
/**
    ...
    SIDO source clock selection.

    Set the SDIO source clok.
*/
//@{
#define SDIO_SRC_CLK_40MHZ      0       ///< Source clock is 40 MHz
#define SDIO_SRC_CLK_48MHZ      1       ///< Source clock is 48 MHz
#define SDIO_SRC_CLK_60MHZ      2       ///< Source clock is 60 MHz
#define SDIO_SRC_CLK_PLL2_D12   3       ///< Source clock is PLL2/12
//@}

/**
    @name SDIO clock output high or low when auto-gating
...
*/
//@{
#define SDIO_CLK_AUTOGATING_LOW     0   ///< Clock will output low when auto-gating
#define SDIO_CLK_AUTOGATING_HIGH    1   ///< Clock will output high when auto-gating
//@}
...
typedef enum
{
    SDIO_CONFIG_ID_BUS_SPEED_MODE,          ///< Select Bus Speed Mode (DS, HS, SDR12, SDR25, SDR50, DDR50)
                                            ...
                                            ///< - @b SDIO_BUS_SPEED_MODE_SDR12 (Not support in NT96220)
                                            ///< - @b SDIO_BUS_SPEED_MODE_SDR25 (Not support in NT96220)
                                            ///< - @b SDIO_BUS_SPEED_MODE_SDR50 (Not support in NT96220)
                                            ///< - @b SDIO_BUS_SPEED_MODE_DDR50 (Not support in NT96220)
    ...
    SDIO_CONFIG_ID_SRCLK,                   ///< Set source clock for SDIO host
                                            ///< Context can be any of:
                                            ///< - @b SDIO_SRC_CLK_40MHZ
                                            ///< - @b SDIO_SRC_CLK_48MHZ (Defalut value)
                                            ///< - @b SDIO_SRC_CLK_60MHZ
                                            ///< - @b SDIO_SRC_CLK_PLL2_D12
    ...
    SDIO_CONFIG_ID_HS_MAX_CLK,              ///< Set maximum clock frequency in High Speed Mode
                                            ...
                                            ///< Valid when SDIO_CONFIG_ID_DRIVING_SINK_EN has SDIO_BUS_SPEED_MODE_HS
    ...
    SDIO_CONFIG_ID_SDR12_MAX_CLK,           ///< Set maximum clock frequency in UHS-I SDR12 Mode
                                            ///< (Valid value: 1~25000000, unit: Hz)
                                            ///< (Valid when SDIO_CONFIG_ID_DRIVING_SINK_EN has SDIO_BUS_SPEED_MODE_SDR12)
    SDIO_CONFIG_ID_SDR12_DRIVING,           ///< Set driving/sink when card is operated in UHS-I SDR12 Mode
                                            ///< (valid context: 2.5 ~ 10.0, unit: uA)
                                            ///< (Valid when SDIO_CONFIG_ID_DRIVING_SINK_EN has SDIO_BUS_SPEED_MODE_SDR12)
    ...
    SDIO_CONFIG_ID_SDR25_MAX_CLK,           ///< Set maximum clock frequency in UHS-I SDR25 Mode
                                            ///< (Valid value: 1~50000000, unit: Hz)
                                            ///< (Valid when SDIO_CONFIG_ID_DRIVING_SINK_EN has SDIO_BUS_SPEED_MODE_SDR25)
    ...
    SDIO_CONFIG_ID_SDR50_MAX_CLK,           ///< Set maximum clock frequency in UHS-I SDR50 Mode
                                            ...
                                            ///< (Valid when SDIO_CONFIG_ID_DRIVING_SINK_EN has SDIO_BUS_SPEED_MODE_SDR50)
    ...
    SDIO_CONFIG_ID_DDR50_MAX_CLK,           ///< Set maximum clock frequency in UHS-I DDR50 Mode
                                            ///< (Valid value: 1~50000000, unit: Hz)
                                            ///< (Valid when SDIO_CONFIG_ID_DRIVING_SINK_EN has SDIO_BUS_SPEED_MODE_DDR50)
    ...
    //#NT#2012/02/10#HH Chuang -begin
    //#NT#Add LBA remap feature (support hidden file system on SDIO)
    SDIO_CONFIG_ID_LBA_REMAP,               ///< Enable/Disable LBA remap feature. Context can be any of:
                                            ///< - @b TRUE: enable LBA remap
                                            ///< - @b FALSE: disable LBA remap (default value)
    //#NT#2012/02/10#HH Chuang -end
    //#NT#2012/06/12#HH Chuang -begin
...
typedef struct
{
    ...
    //#NT#2011/07/04#HH Chuang -begin
    //#NT#export CID for upper layer
...
//#NT#2011/06/28#Chris Hsu -begin
//#NT#Remove obsolete code
/*
...
extern void                     sdio_enSpreadSpectrum(BOOL bEn);
extern void                     sdio_enImproveCompatibility(BOOL bEn);
extern void                     sdio_setFormatParam(INT8* pOemID, INT8* pVolumeLab, BOOL bRandomVolID, UINT32 uiVolID);
*/
//#NT#2011/06/28#Chris Hsu -end
