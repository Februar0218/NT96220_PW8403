/**
    ...
    @brief      Header file of ADPCM Encode/Decode Library.
...
UINT32 adpcm_encodeMono  (INT16 *pInData, INT8 *pOutData, UINT32 uiSampleCount, PADPCM_STATE pState);
UINT32 adpcm_encodeStereo(INT16 *pInData, INT8 *pOutData, UINT32 uiSampleCount, PADPCM_STATE pState);

UINT32 adpcm_decodeMono  (INT8 *pInData, INT16 *pOutData, UINT32 uiSampleCount, PADPCM_STATE pState);
UINT32 adpcm_decodeStereo(INT8 *pInData, INT16 *pOutData, UINT32 uiSampleCount, PADPCM_STATE pState);

UINT32 adpcm_encodePacketMono  (INT16 *pInData, INT8 *pOutData, UINT32 uiSampleCount, PADPCM_STATE pState);
UINT32 adpcm_encodePacketStereo(INT16 *pInData, INT8 *pOutData, UINT32 uiSampleCount, PADPCM_STATE pState);

UINT32 adpcm_decodePacketMono  (INT8 *pInData, INT16 *pOutData, UINT32 uiSampleCount);
UINT32 adpcm_decodePacketStereo(INT8 *pInData, INT16 *pOutData, UINT32 uiSampleCount);
