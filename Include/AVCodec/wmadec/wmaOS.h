...
void PerfTimerStart(PERFTIMERINFO *pObject);
void PerfTimerStop(PERFTIMERINFO *pObject, long lSamplesDecoded);
void PerfTimerStopElapsed(PERFTIMERINFO *pObject);
void PerfTimerReport(PERFTIMERINFO *pObject);
float fltPerfTimerDecodeTime(PERFTIMERINFO *pObject);
void PerfTimerFree(PERFTIMERINFO *pObject);
#ifdef __cplusplus
}
#endif  // __cplusplus
