...
#ifndef _LENSDRV_ST2089_H
#define _LENSDRV_ST2089_H
//#include "constant.h"
#include "Type.h"
...
//#NT#2012/06/04#KS Hung -begin
#define ZOOM_POS_INNER_STOP     0
#define ZOOM_POS_GARAGE         16//17
#define ZOOM_POS_HOME_PR        30//60
#define ZOOM_POS_WIDE           (ZOOM_POS_HOME_PR + 280)//(ZOOM_POS_HOME_PR + 250)
#define ZOOM_POS_TELE           (ZOOM_POS_HOME_PR + 670)//(ZOOM_POS_HOME_PR + 720)
#define ZOOM_POS_OUTER_STOP     (ZOOM_POS_HOME_PR + 745)
//#NT#2012/06/04#KS Hung -end
...
#define FOCUS_POS_INNER_STOP     (FOCUS_POS_HOME_DEF-50)
#define FOCUS_POS_GARAGE         (FOCUS_POS_HOME_DEF-28)
#define FOCUS_POS_HOME_PR        (FOCUS_POS_HOME_DEF-0)
#define FOCUS_POS_NORMAL_WIDE    (FOCUS_POS_HOME_DEF+289)
#define FOCUS_POS_OUTER_STOP     (FOCUS_POS_HOME_DEF+370)

#define FOCUS_BWD_LIMIT_OUTSIDE_PI  360//(380+36)
#define FOCUS_FWD_LIMIT_INSIDE_PI   (36+36)
