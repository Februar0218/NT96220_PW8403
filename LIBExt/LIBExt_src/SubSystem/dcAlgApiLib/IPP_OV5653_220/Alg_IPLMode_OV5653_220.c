...
ER IPL_ChgModeOffTo(IPL_OBJ *Obj)
{
    ...
    switch(Obj->Mode)
    {
        ...
        case IPL_MODE_VIDEO:
            ...
            //hook ipp isrcb func
            Isr_cb.SIEISR_CB = OV5653_sie_isrCB;
            Isr_cb.IPEISR_CB = OV5653_ipe_isrCB;
            Isr_cb.IMEISR_CB = OV5653_ime_isrCB;
...
ER IPL_ChgModeVidTo(IPL_OBJ *Obj)
{
    ...
    switch(Obj->Mode)
    {
        ...
        case IPL_MODE_VIDEOREC:
            ...
            IPPCTRL_SetCmd(ippctrl_obj);
            //config sensor
            if(gImageAlgInfo.Vid_Resolution == _Resolution_1280x720P60)
                Sensor_ChgMode(SENSOR_MODE_1280X720P60);
