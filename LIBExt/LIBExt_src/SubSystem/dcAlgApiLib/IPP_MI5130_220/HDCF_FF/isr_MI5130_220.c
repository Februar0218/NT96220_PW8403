...
void MI5130_sie_isrCB(UINT32 IntStatus)
{
    //customized op
...
void MI5130_ime_isrCB(UINT32 IntStatus)
{
    //customized op
...
void MI5130_ipe_isrCB(UINT32 IntStatus)
{
    //customized op
...
void MI5130_ife_isrCB(UINT32 IntStatus)
{
    //customized op
