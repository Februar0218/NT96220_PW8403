...
#if NT99143_220
UINT32 gDzoomSenModeChgTable[10]={99,99,99,99,99,99,99,99,99,99};
...
UINT32 GetDzoomSenModeChg(UINT32 index){
    return gDzoomSenModeChgTable[index];
}

UINT32 Get_DzoomRatioBySensor(UINT32 DzoomIdx){
    return (gDzoomTbl[0][1] * 100) /gDzoomTbl[DzoomIdx - 10][1];
}
#endif
