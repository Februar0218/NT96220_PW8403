#ifndef _IQSETTING_MI5140_220_H
#define _IQSETTING_MI5140_220_H
...
extern __align(4) UINT32  SRA_SIE_GammaLUT_Cap[65];
extern __align(4) UINT32  SRA_SIE_GammaLUT_Dark[65];
