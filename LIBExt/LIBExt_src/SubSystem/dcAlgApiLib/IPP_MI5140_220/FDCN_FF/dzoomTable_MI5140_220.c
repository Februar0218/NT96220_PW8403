...
const UINT32 VDOZOOM_INFOR_MODE_1_TABLE[41][6] =
{
    //sie_in        pre_out
...
const UINT32 VDOZOOM_INFOR_MODE_2_TABLE[41][6] =
{
    //sie_in        pre_out
...
//full resolution
const UINT32 VDOZOOM_INFOR_MODE_3_TABLE[41][6] =
{
    //sie_in        pre_out
...
UINT32*  SenMode2Tbl(UINT32 SenMode,UINT32 *DzMaxidx)
{
    switch(SenMode)
    {
        ...
        case SENSOR_MODE_640X480:
            memcpy(gDzoomTbl,VDOZOOM_INFOR_MODE_1_TABLE,sizeof(UINT32)*41*6);
            break;

        case SENSOR_MODE_1280X960:
            memcpy(gDzoomTbl,VDOZOOM_INFOR_MODE_2_TABLE,sizeof(UINT32)*41*6);
            break;

        case SENSOR_MODE_FULL:
            memcpy(gDzoomTbl,VDOZOOM_INFOR_MODE_3_TABLE,sizeof(UINT32)*41*6);
            break;
        default:
            debug_err(("%d %s\r\n",__LINE__,__func__));
        break;
