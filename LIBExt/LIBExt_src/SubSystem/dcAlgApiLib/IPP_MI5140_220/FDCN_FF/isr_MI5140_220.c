...
void MI5140_sie_isrCB(UINT32 IntStatus)
{
    //customized op
...
void MI5140_ime_isrCB(UINT32 IntStatus)
{
    //customized op
...
void MI5140_ipe_isrCB(UINT32 IntStatus)
{
    //customized op
...
void MI5140_ife_isrCB(UINT32 IntStatus)
{
    //customized op
