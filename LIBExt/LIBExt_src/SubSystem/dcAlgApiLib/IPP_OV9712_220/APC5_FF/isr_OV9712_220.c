...
void OV9712_sie_isrCB(UINT32 IntStatus)
{
    //customized op
...
void OV9712_ime_isrCB(UINT32 IntStatus)
{
    //customized op
...
void OV9712_ipe_isrCB(UINT32 IntStatus)
{
    //customized op
...
void OV9712_ife_isrCB(UINT32 IntStatus)
{
    //customized op
