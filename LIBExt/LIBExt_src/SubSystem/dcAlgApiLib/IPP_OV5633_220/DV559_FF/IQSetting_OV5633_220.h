#ifndef _IQSETTING_OV5633_220_H
#define _IQSETTING_OV5633_220_H
...
//#NT#add image filter
extern __align(4) IMAGE_FILTER ImgFilterTab[_IMGFilter_Max];
//#NT#2011/08/22#Bowen Li -end
extern UINT32 *SRA_SIE_GammaLUT_Using;
#endif
