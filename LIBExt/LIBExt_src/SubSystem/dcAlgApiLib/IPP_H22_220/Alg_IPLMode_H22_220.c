...
ER IPL_ChgModeOffTo(IPL_OBJ *Obj)
{
    ...
    switch(Obj->Mode)
    {
        ...
        case IPL_MODE_VIDEO:
            ...
            //hook ipp isrcb func
            Isr_cb.SIEISR_CB = H22_sie_isrCB;
            Isr_cb.IPEISR_CB = H22_ipe_isrCB;
            Isr_cb.IMEISR_CB = H22_ime_isrCB;
