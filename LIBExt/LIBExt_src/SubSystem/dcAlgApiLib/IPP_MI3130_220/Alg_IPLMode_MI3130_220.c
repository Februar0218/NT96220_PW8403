/*
    ...
    @file       Alg_IPLMode_MI3130_220.c
    @ingroup        IPP_MI3130_220
    @note       Nothing.

    Porting by Randy Ho  2012/03/07
...
ER IPL_ChgModeOffTo(IPL_OBJ *Obj)
{
    ...
    case IPL_MODE_VIDEO:
        ...
        ////////[NTK#RandyHo]<2012/03/14>
        // Sensor_ChgMode(SENSOR_MODE_1024X768);
         // Sensor_ChgMode(SENSOR_MODE_640X480);

         // HD-mode added by [NTK#RandyHo]<2012/06/07>
        if(Obj->uiImeOutWidth2 == 1280 ||Obj->uiImeOutWidth2 == 1920)
        {
        ...
        //hook ipp isrcb func
        Isr_cb.SIEISR_CB = MI3130_sie_isrCB;
        Isr_cb.IPEISR_CB = MI3130_ipe_isrCB;
        Isr_cb.IMEISR_CB = MI3130_ime_isrCB;
...
ER IPL_ChgModeVidTo(IPL_OBJ *Obj)
{
    ...
    case IPL_MODE_VIDEOREC:
        ...
        IPPCTRL_SetCmd(ippctrl_obj);
        //config sensor
        Sensor_ChgMode(SENSOR_MODE_1024X768);//ethan_20110808_mark, same resolution with preview
...
ER IPL_ChgModeRecTo(IPL_OBJ *Obj)
{
    ...
    case IPL_MODE_VIDEO:
        ...
        Dcout_Setcmd(&jpgobj);
        //config sensor
        Sensor_ChgMode(SENSOR_MODE_1024X768);//same resolution with preview
        //config Image pipeline
        ippctrl_obj.fpIppFlowApi = Set2Preview;
        ippctrl_obj.fpStrongFlow = NULL;
        ippctrl_obj.IPPctrl_info.uiDzoomStep = Obj->uiDzoomStep;
