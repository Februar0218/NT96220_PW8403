...
*/
#ifndef _AE_MI5100_220_INT_H_
#define _AE_MI5100_220_INT_H_
...
#define AE_EXPECT_Y                 64//76                          ///< expectY
...
#define AE_ADJ_INDOOR_MAX_Y         8                          ///< adjust indoor max y
#define AE_ADJ_OVER_EXPO_TH         (6 * 5)                     ///< adjust over exposure threshold
#define AE_ADJ_UNDER_EXPO_TH        (6 * 5 / 3)                 ///< adjust under exposure threshold
...
extern const UINT32 AeCurve_Shake50[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_Shake60[][AEALG_INFO_MAX];
/**
