...
*/
#ifndef _AE_MI9130_220_INT_H_
#define _AE_MI9130_220_INT_H_
...
#define AE_REDUCE_OVER_EXPO_MODE    DISABLE                      ///< reduce over exposure mode switch
...
#define AE_EXPECT_Y                 65//70//60                          ///< expectY
#define AE_MAX_ISO                  400//800                         ///< max iso
#define AE_MIN_ISO                  50                          ///< min iso

#define AE_ADJ_Y_STEP               2                           ///< adjust Y step
#define AE_ADJ_OUTDOOR_EV           ((1 << 11) * 10)            ///< outdoor boundary
#define AE_ADJ_INDOOR_EV            ((1 << 10) * 10)            ///< indoor boundary
#define AE_ADJ_OUTDOOR_MAX_Y        5//10                          ///< adjust outdoor max y
#define AE_ADJ_INDOOR_MAX_Y         10                          ///< adjust indoor max y
...
#define AE_EV_RATIO                (128)// (100)

#define AE_ADJ_NIGHT_EV             ((1 << 5) * 10) 
#define AE_ADJ_NIGHT_MAX_Y          AE_ADJ_INDOOR_MAX_Y                           ///< adjust night max y
#define AE_ADJ_CENTER_OVER_EXPO_TH  (30)                 ///< adjust center over exposure threshold
...
//#NT#2011/06/30#Jarkko Chang -begin
//#NT# 
/**
     AE Reset Flag.
...
//#NT#2011/06/30#Jarkko Chang -end
...
extern const UINT32 AeCurve_NoramlCapture60[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_NoramlCapture50[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_AntiShake60[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_AntiShake50[][AEALG_INFO_MAX];
...
/**
     ...
     @param[in] antishake parameter
     @param[out] ae information
*/
extern void AE_getCapTab(AE_ISO nISO, AE_FLICKER nFlicker, AE_SCENE nScene, AE_ANTISHAKE nShakeLevel, AE_INFO *AeInfo);
...
*/
extern void AE_setExpT(UINT32 ExpT);
...
/**
     ...
     @param[in] iso gain
*/
extern void AE_setGain(UINT32 ISO);
...
extern UINT32 AE_getMinLV(void);
extern UINT32 AE_GetExpectYLum(void);
