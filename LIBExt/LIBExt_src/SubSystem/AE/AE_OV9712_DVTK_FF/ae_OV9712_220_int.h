...
#define AE_EXPECT_Y                 66//55 //66                          ///< expectY
...
#define AE_ADJ_NIGHT_EV             ((1 << 6) * 10)            ///< night boundary
...
#define AE_ADJ_CENTER_OVER_EXPO_TH  (90)//(30)                 ///< adjust center over exposure threshold
