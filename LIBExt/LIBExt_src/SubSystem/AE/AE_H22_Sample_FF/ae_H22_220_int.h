...
*/
#ifndef _AE_H22_220_INT_H_
#define _AE_H22_220_INT_H_
...
#define AE_MAX_EV                   ((1 << 17) * 10)            ///< ae max EV
...
#define AE_ADJUST_RATIO_H           200//200//200                         ///< adjust ratio H
#define AE_ADJUST_RATIO_L           70//70//60//50                          ///< adjust ratio L
#define AE_SMOOTH_PRV_W             2                           ///< weighting
#define AE_SMOOTH_NEW_W             5                           ///< weighting
#define AE_EXPECT_Y                 50//40//45//57//66                          ///< expectY
#define AE_MAX_ISO                  600//800                         ///< max iso
#define AE_MIN_ISO                  100//100                          ///< min iso

#define AE_ADJ_Y_STEP               1                           ///< adjust Y step
#define AE_ADJ_OUTDOOR_EV           ((1 << 11) * 10)            ///< outdoor boundary
#define AE_ADJ_INDOOR_EV            ((1 << 9) * 10)            ///< indoor boundary
#define AE_ADJ_NIGHT_EV             ((1 << 5) * 10)            ///< night boundary
#define AE_ADJ_OUTDOOR_MAX_Y        5                           ///< adjust outdoor max y
#define AE_ADJ_INDOOR_MAX_Y         AE_ADJ_OUTDOOR_MAX_Y        ///< adjust indoor max y
#define AE_ADJ_NIGHT_MAX_Y          55//45//45                           ///< adjust night max y
#define AE_ADJ_OVER_EXPO_TH         (6 * 5)                     ///< adjust over exposure threshold
...
extern const UINT32 AeCurve_AntiShake_60Hz[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_AntiShake_50Hz[][AEALG_INFO_MAX];
/**
