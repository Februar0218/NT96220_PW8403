...
*/
#ifndef _AE_MI5131E_220_INT_H_
#define _AE_MI5131E_220_INT_H_
...
#define AE_MAX_EV                   ((1 << 16) * 10)            ///< ae max EV
//#define AE_MIN_EV                   ((1 << 5) * 10)             ///< ae min EV
// request of adpk engineer side
#define AE_MIN_EV                   ((1 << 7) * 10)             ///< ae min EV
...
#define AE_EXPECT_Y                 70                          ///< expectY
#define AE_MAX_ISO                  800                         ///< max iso
//iso50 map to 2.xx analog gain
#define AE_MIN_ISO                  25                          ///< min iso
...
#define AE_ADJ_OUTDOOR_MAX_Y        9                           ///< adjust outdoor max y
#define AE_ADJ_INDOOR_MAX_Y         12                          ///< adjust indoor max y
#define AE_ADJ_OVER_EXPO_TH         (7 * 5)                     ///< adjust over exposure threshold
#define AE_ADJ_UNDER_EXPO_TH        (7 * 5 / 3)                 ///< adjust under exposure threshold
...
extern const UINT32 AeCurve_Cap50_antishake[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_Cap60_antishake[][AEALG_INFO_MAX];
/**
