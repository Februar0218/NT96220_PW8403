...
*/
#ifndef _AE_S5K3E2_220_INT_H_
#define _AE_S5K3E2_220_INT_H_
...
#define AE_SMOOTH_PRV_W             1                           ///< weighting
#define AE_SMOOTH_NEW_W             3                           ///< weighting
#define AE_EXPECT_Y                 76//46//43                          ///< expectY
...
#define AE_ADJ_OUTDOOR_MAX_Y       5//0// 20                          ///< adjust outdoor max y
#define AE_ADJ_INDOOR_MAX_Y         5//10                          ///< adjust indoor max y
#define AE_ADJ_OVER_EXPO_TH         (12 * 5)                     ///< adjust over exposure threshold
#define AE_ADJ_UNDER_EXPO_TH        (1 * 5 / 3)                 ///< adjust under exposure threshold
