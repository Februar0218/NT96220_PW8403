...
*/
#ifndef _AE_MI5140_220_INT_H_
#define _AE_MI5140_220_INT_H_
...
#define AE_REDUCE_OVER_EXPO_MODE    DISABLE//ENABLE   //                    ///< reduce over exposure mode switch
...
#define AE_MIN_ISO                  50//50                          ///< min iso
...
#define AE_ADJ_OUTDOOR_MAX_Y        2//10                           ///< adjust outdoor max y
#define AE_ADJ_INDOOR_MAX_Y         10                          ///< adjust indoor max y
#define AE_ADJ_OVER_EXPO_TH         (8 * 5)                     ///< adjust over exposure threshold
#define AE_ADJ_UNDER_EXPO_TH        (9 * 5 / 3)                 ///< adjust under exposure threshold
#define AE_EV_RATIO                 (100)

#define AE_ADJ_NIGHT_EV             ((1 << 3) * 10) 
...
extern const UINT32 AeCurve_Shake_60Hz[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_Shake_50Hz[][AEALG_INFO_MAX];
/**
