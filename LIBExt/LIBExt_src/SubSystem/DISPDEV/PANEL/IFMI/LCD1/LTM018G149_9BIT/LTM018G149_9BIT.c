...
const tPANEL_CMD tCmdModeMiFmt7[] =
{
    {0x0000,        0x0001},
    {CMDDELAY_MS,   10},
    {0x0007,        0x0000},
...
{
    /***********       MI Format 7 - 9bits bus RGB666      *************/
    {
        // tPANEL_PARAM
        {
            /* Old prototype */
            PINMUX_LCDMODE_MI_FMT7,         //!< LCDMode
            2.7f,                           //!< fDCLK
        ...
        {
            /* Old prototype */
            PINMUX_LCD_SEL_PARALLE_MI_9BITS,//!< pinmux_select_lcd;
            ICST_CCIR601,                   //!< icst;
        ...
        (tPANEL_CMD*)tCmdModeMiFmt7,                  //!< pCmdQueue
        sizeof(tCmdModeMiFmt7)/sizeof(tPANEL_CMD),    //!< nCmd
    }
};
...
void      dispdev_setMiConfig(tMI_CONFIG *pMiConfig)
{
    ...
    mi_setCtrl(PARALLEL_I80, MI_AUTOFMT3, pMiConfig->DataFmt, FALSE, FALSE, bTeSyncEn, FALSE);
