...
static DISPDEV_OBJ     DispDev_IFMiObj_Lcd1 = { dispdev_openIFMi, dispdev_closeIFMi, dispdev_setDeviceRotate, dispdev_writeLcdReg, dispdev_readLcdReg, dispdev_setIFMiIOCTRL, {NULL,NULL}};
static volatile DISPDEV_IOCTRL  pIFMiIoControl1 = NULL;
#elif (DISPLCDSEL_IFMI_TYPE == DISPLCDSEL_IFMI_LCD2)
static DISPDEV_OBJ     DispDev_IFMiObj_Lcd2 = { dispdev_openIFMi, dispdev_closeIFMi, dispdev_setDeviceRotate, dispdev_writeLcdReg, dispdev_readLcdReg, dispdev_setIFMiIOCTRL, {NULL,NULL}};
...
static ER dispdev_openIFMi(void)
{
    ...
    default:
        debug_err(("LTM018G149 not supported mode! \r\n"));
        break;
    }
...
static ER dispdev_closeIFMi(void)
{
    ...
    dispanl_debug(("^GcloseIFMi START\r\n"));
    ...
    if(pStandby != NULL)
    {
        ...
        for(i=0; i<CmdNumber; i++)
        {
            ...
            {
                TimerDelayMs(pStandby[i].uiValue);
            }
            else if (pStandby[i].uiAddress == CMDDELAY_US)
            {
                TimerDelayUs(pStandby[i].uiValue);
            }
            else
            {
