...
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif   (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_T27BDHJ102)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif     (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_TXDT200L)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif     (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_ALT020DSLN_J2)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif     (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_TOPPOLYTD020)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_TXDT250C)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_PROB2706)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#elif (DISPDEV_IF8BITS_TYPE == DISPDEV_IF8BITS_TXDT300CDRT_25)
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#else
#define SETTING_SIF_MODE                    OPTION_SIF_0000
#endif
    ...
    #define USED_SIF_MODE     SIF_MODE_0110
    #define SIF_CLK_INIT()    gpio_clearPin(SifClk)
    #define SIF_CLK_BEGIN()   gpio_setPin(SifClk)
    #define SIF_CLK_END()     gpio_clearPin(SifClk)
    #define SIF_SEN_INIT()    gpio_clearPin(SifSen)
