...
//Add RGB mode support
#define TXDT270M_RGB_Buf_width       480
#define TXDT270M_RGB_Buf_height      240
#define TXDT270M_RGB_Win_width       480
#define TXDT270M_RGB_Win_height      240
...
static void Init_TXDT270M_LCD(void)
{
    ...
    case PINMUX_LCDMODE_RGBD320:
        ...
        sendToLcdReg(0x00, 0x0d);  //
        TimerDelayMs(10);

        sendToLcdReg(0x00, 0x05);//0x01
        TimerDelayMs(10);

        sendToLcdReg(0x00, 0x05);//
        TimerDelayMs(50);

        sendToLcdReg(0x00, 0x0d);  //
        TimerDelayMs(10);

        sendToLcdReg(0x60, 0x01);  //
        //test_write2(0x40, 0x03);
        sendToLcdReg(0xa0, 0x08);
        break;
...
void OpenTXDT270M(LCDSIZE *psizeDisplay)
{
    ...
    case PINMUX_LCDMODE_RGBD320:
        ...
        ide_setOdd(IDE_LCD_B);
        ide_setEven(IDE_LCD_R);
        ...
        ide_set_hor_timing(1, 1559, 251, 1280+251-1);
        //ide_set_ver_timing(0, 243, 1, 241, 2, 242);
        ide_set_ver_timing(1, 261, 13, 240+13-1, 13, 240+13-1);

//        ide_setHorTiming(0x01, 1716-1, 241+3, 1681+3);
