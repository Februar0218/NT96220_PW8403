/*
    @file       Toppoly99000543_636.c
    @brief      LCD Driver of Toppoly 99000543/99000636 Panel
    @author     Niven Cho
    @date       2009/07/14
...
static const tPANEL_CMD tCmdModeThrough[] = {
    {0x02, INPUT_FORMAT_THROUGH|INPUT_FORMAT_STD_NTSC|INPUT_VALID_DATA_1280|INPUT_CLK_EDGE_POS|INPUT_HD_POL_LOW|INPUT_VD_POL_LOW},
    {0x03, NONINTERLACE_MODE},
    //{0x04, POWER_NORMAL|CP_CLK_ENABLE|PWM_OUTPUT_ENABLE|PRE_CHARGE_ENABLE|OUTPUT_DRIVER_50},
};
    ...
    {//LCD_MODE_YUV Begin
        {
            ...
            6.24f,          //!< DCLK;  //FPGA
#else
            18.42f,             //!< DCLK;  //Real chip
#endif
            1171,           //!< HSyncTotalPeriod;
            960,           //!< HSyncActivePeriod;
            150,            //!< HSyncBackPorch;
            262,            //!< VSyncTotalPeriod;
            240,            //!< VSyncActivePeriod;
            14,             //!< VSyncBackPorchOdd;
            14,             //!< VSyncBackPorchEven;
            960,            //!< BufferWidth;
            240,            //!< BufferHeight;
            960,            //!< WindowWidth;
            240,            //!< WindowHeight;
...
void DeviceOpen(LCDSIZE *psizeDisplay)
{
    ...
    pinmux_setPinmux(PINMUX_FUNC_ID_LCD, pIDE->pinmux_select_lcd);//PINMUX_LCD_SEL_CCIR601
