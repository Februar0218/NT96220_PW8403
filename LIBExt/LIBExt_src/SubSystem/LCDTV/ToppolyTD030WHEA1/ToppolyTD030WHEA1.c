/*
    @file       ToppolyTD030WHEA1.c
    @brief      LCD Driver of Toppoly TD030WHEA1 Panel
    @author     Niven Cho
    @date       2009/08/28
...
#define PHASE_SH1                   0x08
#define PHASE_SH2                   0x10
#define PHASE_SH3                   0x18
#define PHASE_SH4                   0x20
#define PHASE_SH5                   0x28
#define PHASE_SH6                   0x30
#define PHASE_SH7                   0x38
#define PHASE_SH8                   0x40
#define PHASE_SH9                   0x48
#define PHASE_SH10                  0x50
#define PHASE_SH11                  0x58
#define PHASE_SH12                  0x60
#define PHASE_SH13                  0x68
#define PHASE_SH14                  0x70
#define PHASE_SH15                  0x78
...
static const tPANEL_CMD tCmdStandby[] = { //Standby Mode, for ClosePanel()
    {0x04,POWER_STANDBY}, //Set R0 to Standby
};


static const tPANEL_CMD tCmdModeYUV[] = {
    {0x02, INPUT_FORMAT_YUV|INPUT_FORMAT_STD_NTSC|INPUT_VALID_DATA_1280|INPUT_CLK_EDGE_POS|INPUT_HD_POL_LOW|INPUT_VD_POL_LOW},
    {0x03, NONINTERLACE_MODE},
    {0x04, POWER_NORMAL|CP_CLK_ENABLE|PWM_OUTPUT_ENABLE|PRE_CHARGE_ENABLE|OUTPUT_DRIVER_50},
};

/*
static tPANEL_CMD tCmdModeYUV360[] = {
    {0x02, INPUT_FORMAT_YUV|INPUT_FORMAT_STD_NTSC|INPUT_VALID_DATA_1440|INPUT_CLK_EDGE_POS|INPUT_HD_POL_LOW|INPUT_VD_POL_LOW},
    {0x03, NONINTERLACE_MODE},
    {0x04, POWER_NORMAL|CP_CLK_ENABLE|PWM_OUTPUT_ENABLE|PRE_CHARGE_ENABLE|OUTPUT_DRIVER_50},
};

static tPANEL_CMD tCmdModeRGBD[] = {
    {0x02, INPUT_FORMAT_RGBD|INPUT_FORMAT_STD_NTSC|INPUT_VALID_DATA_1280|INPUT_CLK_EDGE_POS|INPUT_HD_POL_LOW|INPUT_VD_POL_LOW},
    {0x03, NONINTERLACE_MODE},
    {0x04, POWER_NORMAL|CP_CLK_ENABLE|PWM_OUTPUT_ENABLE|PRE_CHARGE_ENABLE|OUTPUT_DRIVER_50},
};

static tPANEL_CMD tCmdModeRGBD360[] = {
    {0x02, INPUT_FORMAT_RGBD|INPUT_FORMAT_STD_NTSC|INPUT_VALID_DATA_1440|INPUT_CLK_EDGE_POS|INPUT_HD_POL_LOW|INPUT_VD_POL_LOW},
    {0x05, HOR_NORMAL_MODE|VER_NORMAL_MODE|PHASE_SH5},
    {0x03, NONINTERLACE_MODE},
    {0x04, POWER_NORMAL|CP_CLK_ENABLE|PWM_OUTPUT_ENABLE|PRE_CHARGE_ENABLE|OUTPUT_DRIVER_50},
};
*/
...
{
      0, 11, 23, 34, 45, 54, 63, 70, 77, 84,
     90, 95,100,105,109,113,117,121,126,130,
    134,139,145,151,158,166,175,185,196,208,
    223,238,255,
};
