/*
    @file       AUA027DN03.c
    @brief      LCD Driver of AUO DN03 Panel
    @author     Niven Cho
    @date       2009/10/20
...
#define SETTING_PANEL_REG_BIT_SHIFT_ADDRESS 8               //D12 is Address LSB
#define SETTING_PANEL_REG_BIT_SHIFT_VALUE   0               //D0  is Content LSB
#define SETTING_PANEL_REG_BIT_WRITE         14              //D14 is Bit of Write Command
...
void DeviceOpen(LCDSIZE *psizeDisplay)
{
    ...
    //#NT#2009/11/06#Klins Chen -begin
    // LCD Power-ON Sequence Delay
    TimerDelayMs(48);
    //#NT#2009/11/06#Klins Chen -end
