...
//char *pFwVersion = "PW8403 20150424V001";

//char *pFwVersion = "PW90120150629.H22.V002";

//char *pFwVersion = "PW901.150701.9712";
//char *pFwVersion = "PW901.150709.H22";

//char *pFwVersion = "PW901.150711.9712";
char *pFwVersion = "GS8000.150906.H42";  
...
//when LCD is turn off,press any key instead of UP key to turn on LCD.
	...
	{
	if((Primary_GetCurrentMode() == PRIMARY_MODE_MOVIE)&&((gMovData.State !=MOV_ST_MENU)&&((GPIOMap_DetKey() & FLGKEY_UP)||(GPIOMap_DetKey() & FLGKEY_DOWN))))
          return;
    
            *TempKeyStatus = FLGKEY_DISPLAY;
	}
        //if (FlowMovie_GetMovDataState() == MOV_ST_REC)//eric edit 0901
        //GPIOMap_TurnOnLCDBacklight();//eric edit 0901
}
