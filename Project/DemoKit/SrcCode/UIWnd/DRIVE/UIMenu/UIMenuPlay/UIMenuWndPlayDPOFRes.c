...
#ifndef UIMENUWNDPLAYDPOFRES_H
#define UIMENUWNDPLAYDPOFRES_H
...
CREATE_MENU_ITEM_DATA(STRID_SELECT_IMAGES32,STRID_SELECT_IMAGES,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
CREATE_MENU_ITEM_DATA(STRID_ALL_IMAGES33,STRID_ALL_IMAGES,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndPlayDPOF_Menu)
...
DECLARE_EVENT(UIMenuWndPlayDPOF_Menu)
MENU_LIST_BEGIN(UIMenuWndPlayDPOF_Menu)
MENU_LIST_ITEM(STRID_SELECT_IMAGES32)
MENU_LIST_ITEM(STRID_ALL_IMAGES33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndPlayDPOF_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPlayDPOF_Menu,UIMenuWndPlayDPOF_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPlayDPOF_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayDPOF_Panel)
DECLARE_CTRL_LIST(UIMenuWndPlayDPOF_Panel)
CREATE_CTRL(UIMenuWndPlayDPOF_Panel,UIMenuWndPlayDPOF_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPlayDPOF)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayDPOF)
DECLARE_CTRL_LIST(UIMenuWndPlayDPOF)
CREATE_CTRL(UIMenuWndPlayDPOF,UIMenuWndPlayDPOF,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
