...
#ifndef UIMENUWNDPLAYCOPYTOCARDRES_H
#define UIMENUWNDPLAYCOPYTOCARDRES_H
...
CREATE_MENU_ITEM_DATA(STRID_ALL_IMAGES33,STRID_ALL_IMAGES,ICONID_NULL,STATUS_ENABLE,NULL,NULL) 
SHOW_MAP_BEGIN(UIMenuWndPlayCopyToCard_Menu)
...
DECLARE_EVENT(UIMenuWndPlayCopyToCard_Menu)
MENU_LIST_BEGIN(UIMenuWndPlayCopyToCard_Menu)
MENU_LIST_ITEM(STRID_CANCEL32)
MENU_LIST_ITEM(STRID_ALL_IMAGES33)
MENU_LIST_END

CREATE_MENU_DATA(UIMenuWndPlayCopyToCard_Menu,0,2,MENU_LAYOUT_VERTICAL|MENU_DISABLE_SHOW|MENU_SCROLL_CYCLE|MENU_SCROLL_NEXT_PAGE|MENU_DISABLE_NORMAL|MENU_DRAW_IMAGE)

CREATE_MENU_CTRL(UIMenuWndPlayCopyToCard_Menu,UIMenuWndPlayCopyToCard_Menu,0,16,5,231,42)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_MAP_BEGIN(UIMenuWndPlayCopyToCard_Panel)
SHOW_MAP_BODY(Skin2)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayCopyToCard_Panel)
DECLARE_CTRL_LIST(UIMenuWndPlayCopyToCard_Panel)
CREATE_CTRL(UIMenuWndPlayCopyToCard_Panel,UIMenuWndPlayCopyToCard_Panel,CTRL_WND,NULL,0 ,56,50,304,208)
SHOW_MAP_BEGIN(UIMenuWndPlayCopyToCard)
SHOW_MAP_BODY(Skin1)
SHOW_MAP_END

DECLARE_EVENT(UIMenuWndPlayCopyToCard)
DECLARE_CTRL_LIST(UIMenuWndPlayCopyToCard)
CREATE_CTRL(UIMenuWndPlayCopyToCard,UIMenuWndPlayCopyToCard,CTRL_WND,NULL,0 ,0,0,319,239)
#endif
