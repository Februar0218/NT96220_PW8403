...
INT32 UIMenuWndPlayDel_Menu_OnKeyDisplay(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_DISPLAY,UIMenuWndPlayDel_Menu_OnKeyDisplay)
EVENT_END
...
INT32 UIMenuWndPlayDel_Menu_OnKeyDisplay(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  uiKeyAct;
