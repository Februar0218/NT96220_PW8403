...
INT32 UIMenuWndSetupDefaultSetting_List_Text_OnKeyDisplay(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_DISPLAY,UIMenuWndSetupDefaultSetting_List_Text_OnKeyDisplay)
EVENT_END
...
INT32 UIMenuWndSetupDefaultSetting_List_Text_OnKeyDisplay(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  uiKeyAct;
