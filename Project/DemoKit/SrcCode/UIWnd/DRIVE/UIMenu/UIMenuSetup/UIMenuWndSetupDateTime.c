...
INT32 UIMenuWndSetupDateTime_OnKeyDisplay(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_DISPLAY,UIMenuWndSetupDateTime_OnKeyDisplay)
EVENT_END
...
__align(4) static const UINT8 DayOfMonth[2][12] =
{
    // Not leap year
...
INT32 UIMenuWndSetupDateTime_OnKeyDisplay(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  uiKeyAct;
