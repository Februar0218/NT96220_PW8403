...
INT32 MenuCommonOption_OnKeyDisplay(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_KEY_DISPLAY,MenuCommonOption_OnKeyDisplay)
EVENT_END
...
void MenuCommonOption_UpdateContent(TM_MENU* pMenu)
{
    ...
    //MenuCommon_CalcPageInfo(&MenuCommonOption_MenuCtrl); // calculate page information for display
...
INT32 MenuCommonOption_OnKeyDisplay(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  uiKeyAct;
