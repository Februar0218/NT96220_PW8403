...
SHOW_ITEM_GROUP(CMD_Group,Normal78,141,181,248,208)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Date,0,141,181,248,208)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin84Rect,0,0,57,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin84)
SHOW_MAP_BODY(Skin84Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin84,0,0,57,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text86,0,0,57,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal83)
SHOW_MAP_BODY(Skin84)
SHOW_MAP_BODY(Text86)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal83,250,181,307,208)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Time,0,250,181,307,208)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin103Rect,0,0,111,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin103)
SHOW_MAP_BODY(Skin103Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin103,0,0,111,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text105,0,0,107,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,18,0,0,0,0)
SHOW_MAP_BEGIN(Normal102)
SHOW_MAP_BODY(Skin103)
SHOW_MAP_BODY(Text105)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal102,200,32,311,59)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,200,32,311,59)
...
SHOW_ITEM_GROUP(CMD_Group,Normal127,100,181,159,208)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Speed,0,100,181,159,208)
