...
extern VControl UIFlowWndMovie_Status_TimeLapesRecCtrl;//Status type 

typedef enum
{
UIFlowWndMovie_Status_TimeLapesRec_ICONID_NULL,
UIFlowWndMovie_Status_TimeLapesRec_ICON_FLASH_REC,
UIFlowWndMovie_Status_TimeLapesRec_MAX
}UIFlowWndMovie_Status_TimeLapesRec_Setting;

extern VControl UIFlowWndMovie_PanelMotionRecCtrl;//Panel type 
...
typedef enum
{
UIFlowWndMovie_Status_WDR_ICONID_NULL,
